...
function App({ children }) {
  return (
    <div class="min-h-screen bg-[#0f0f0f] text-[#69F5FF]">
      <NavBar />
      {children}
    </div>
  );
...
function NavBar() {
  return (
    // <nav class="font-sans flex flex-col text-center sm:flex-row sm:text-left sm:justify-between py-4 px-6 shadow sm:items-baseline w-full">
    <nav class="sticky top-0 z-10 bg-[#0f0f0f] backdrop-filter backdrop-blur-lg bg-opacity-30">
    ...
    <div class="flex justify-center items-center">
      <div class="max-w-7xl py-12 px-4 sm:px-6 lg:py-24 lg:px-8 lg:flex lg:items-center lg:justify-between">
        <h2 class="text-3xl font-extrabold tracking-tight text-gray-900 md:text-4xl">
          ...
          <span class="block text-indigo-600">Find your bagel today.</span>
          <span class="block text-indigo-600">Find your bagel today.</span>
          <span class="block text-indigo-600">Find your bagel today.</span><span class="block text-indigo-600">Find your bagel today.</span>
          <span class="block text-indigo-600">Find your bagel today.</span>
          <span class="block text-indigo-600">Find your bagel today.</span>
          <span class="block text-indigo-600">Find your bagel today.</span>
          <span class="block text-indigo-600">Find your bagel today.</span>
